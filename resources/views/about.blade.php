@php($title = "Best Orthopaedic Doctor in Navi Mumbai - Dr. Dhruv Patel")
@section('meta_desc')Meet Dr. Dhruv Patel, best orthopaedic doctor in Navi Mumbai, specializing in arthroscopic and trauma surgery. Book your appointment today! @endsection
            ...
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    <div class="content-column col-md-7 col-sm-12 col-xs-12">
                        <div class="sec-title">
                            <h2 class="doc-name1">  Dr. Dhruv Patel</h2>
                    ...
                    <!--<p>Beyond his exceptional medical qualifications, Dr. Dhruv Patel is known for his compassionate approach to patient care. He understands the physical and emotional challenges that orthopaedic conditions can present and strives to provide personalized, patient-centered care. Dr. Dhruv Patel believes in open communication, ensuring that patients fully understand their conditions, treatment options, and recovery processes.</p>-->
                    <!--        <p>As a Consultant Orthopaedic & Joint Replacement Surgeon, Dr. Dhruv Patel's mission is to restore mobility and enhance the quality of life for his patients. His dedication to excellence, combined with his extensive experience and unwavering commitment to compassionate care, make him a trusted name in the field of orthopaedics. Dr. Dhruv Patel's patients can be confident that they are in capable and caring hands, receiving the best possible orthopaedic treatment and surgical expertise.</p>-->
...
<div class="container">
  ...
  <div class="col-md-4">
    <a class="card2" href="{{route('arthroscopy_surgery')}}">
        ...
        <ul class="list-style-one-set treatment-content">
                      <li>Utilizing small incisions and a camera to diagnose and treat joint issues.</li>
 ...
 <ul class="list-style-one-set treatment-content">
                      <li>Rapid response to fractures, dislocations, and other severe injuries.</li></ul>
  ...
  <div class="col-md-4">
    <a class="card2" href="{{route('joint_replacement_surgery')}}">
        <h3>Joint replacement</h3>
         <ul class="list-style-one-set treatment-content">
          <li>State-of-the-art techniques to replace damaged joints.</li></ul>
  ...
  <div class="col-md-4">
    <a class="card2" href="{{route('spine_surgery')}}">
        <h3>Spine surgery</h3>
                 <ul class="list-style-one-set treatment-content">
          <li>Alleviates chronic back and neck pain.</li></ul>
  ...
  <div class="col-md-4">
    <a class="card2" href="{{route('sports_injuries')}}">
        <h3>Sports injury treatments</h3>
              <ul class="list-style-one-set treatment-content">
    <li>Focus on injuries related to sports and physical activities.</li></ul>
  ...
  <ul class="list-style-one-set treatment-content">
    <li>Restores function and reduces pain in knee and hip joints.</li></ul>
      ...
      <div class="main">
        <div class="service">
          ...
          <h4>Experience</h4>
                  ...
                  <ul class="list-style-one treatment-content">
    <li><span class="bold-set">Over 8 Years of Experience:</span><br> Dr. Dhruv Patel, the best orthopaedic doctor in Navi Mumbai, brings over eight years of expertise in the field of orthopaedics.</li>
    <li><span class="bold-set">Extensive Expertise:</span><br> He has extensive expertise in a wide range of orthopaedic procedures, making him a highly trusted orthopaedic doctor in Navi Mumbai.</li>
    <li><span class="bold-set">Medical Advancements:</span><br> Dr. Dhruv Patel is known for staying abreast of the latest medical advancements to provide the best care possible.</li>
</ul>
        </div>
      </div>
    </div>
      ...
      <div class="main">
        <div class="service">
          ...
          <h4>Approach to Patient Care</h4>
             <ul class="list-style-one treatment-content">
    <li><span class="bold-set">Compassionate Care:</span><br> Dr. Dhruv Patel is committed to compassionate and patient-centered care.</li>
    <li><span class="bold-set">Open Communication:</span><br> Emphasis is placed on open communication and patient education, ensuring patients are well-informed.</li>
    <li><span class="bold-set">Holistic Understanding:</span><br> He understands the physical and emotional challenges faced by patients, offering comprehensive support.</li>
</ul>
      ...
      <div class="main">
        <div class="service">
          ...
          <h4>Mission</h4>
             ...
             <ul class="list-style-one treatment-content">
    <li><span class="bold-set">Restore Mobility:</span><br> Dr. Dhruv Patel's mission is to restore mobility and enhance the quality of life for his patients.</li>
    <li><span class="bold-set">Commitment to Excellence:</span><br> He is dedicated to excellence and unwavering commitment to compassionate care.</li>
    <li><span class="bold-set">Providing Hope:</span><br> Dr. Dhruv Patel aims to provide genuine care and hope to patients in Vashi and Belapur, ensuring they receive the best orthopaedic treatment.</li>
</ul>
...
<div class="container">
    <div class="accordion">
        <!-- <h2 class="accordion__heading">Orthopaedic Frequently Asked Questions</h2> -->

        <div class="accordion__item">
            <button class="accordion__btn">
                <span class="accordion__caption"><i class="far fa-lightbulb"></i>What conditions does Dr. Dhruv Patel treat?</span>
                <span class="accordion__icon"><i class="fa fa-plus"></i></span>
            </button>
            <div class="accordion__content">
                <p>Dr. Dhruv Patel, a renowned and the best orthopaedic doctor in Navi Mumbai, treats a wide range of orthopaedic conditions, including joint pain, arthritis, fractures, and sports injuries. His expertise covers arthroscopic and trauma surgeries as well as joint replacement procedures.</p>
            </div>
        </div>

        <div class="accordion__item">
            <button class="accordion__btn">
                <span class="accordion__caption"><i class="far fa-lightbulb"></i>How do I know if I need joint replacement surgery?</span>
                <span class="accordion__icon"><i class="fa fa-plus"></i></span>
            </button>
            <div class="accordion__content">
                <p>Joint replacement surgery is typically recommended for severe joint pain or damage that does not respond to conservative treatments. Dr. Dhruv Patel, an experienced orthopaedic doctor in Navi Mumbai, will assess your condition and discuss the best treatment options with you.</p>
            </div>
        </div>

        <div class="accordion__item">
            <button class="accordion__btn">
                <span class="accordion__caption"><i class="far fa-lightbulb"></i>What is the recovery time for arthroscopic surgery?</span>
                <span class="accordion__icon"><i class="fa fa-plus"></i></span>
            </button>
            <div class="accordion__content">
                <p>Recovery times can vary, but generally, patients can expect a quicker recovery with arthroscopic surgery compared to traditional surgery. Dr. Dhruv Patel will provide a detailed recovery plan tailored to your specific procedure.</p>
            </div>
        </div>

        <div class="accordion__item">
            <button class="accordion__btn">
                <span class="accordion__caption"><i class="far fa-lightbulb"></i>Is trauma surgery performed immediately after an injury?</span>
                <span class="accordion__icon"><i class="fa fa-plus"></i></span>
            </button>
            <div class="accordion__content">
                <p>Yes, trauma surgery is often performed urgently to address severe injuries. Dr. Dhruv Patel, a leading and the best orthopaedic doctor in Navi Mumbai is skilled in providing immediate and effective care to ensure the best possible outcomes.</p>
            </div>
        </div>

        <div class="accordion__item">
            <button class="accordion__btn">
                <span class="accordion__caption"><i class="far fa-lightbulb"></i>How can I book an appointment with Dr. Dhruv Patel?</span>
                <span class="accordion__icon"><i class="fa fa-plus"></i></span>
            </button>
            <div class="accordion__content">
                <p>Appointments can be booked by contacting Dr. Dhruv Patel's OrthoCare Clinic directly via phone: +91 9167116802 / +91 9987791991 or email: drdhruvpatelsorthocareclinic@gmail.com. The clinic staff will assist you in scheduling a convenient time for your consultation.</p>
            </div>
        </div>
